...
export default function SubmitProposalPage() {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    // TODO: Replace with your API call to submit a proposal for the project.
    console.log('Submitting proposal for project', id, values);

    toast({
      title: 'Proposal Submitted!',
      description: `Your proposal has been successfully submitted for the project.`,
    });
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <CardHeader>
              ...
              <CardDescription>
                You are submitting a proposal for the project: <span className="font-semibold text-foreground">{project.title}</span>
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
               <FormField
